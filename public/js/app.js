...
__webpack_require__(/*! ./getComments */ "./resources/js/getComments.js");
...
var buttonEdit = document.querySelectorAll('.comments__in-edit');
...
function EditingComments(e) {
  ...
  var replaceP = document.getElementById("message" + e.target.id);
  var pValue = replaceP.innerHTML;
  console.log(pValue); // создаю и настраиваю input
  ...
  input.placeholder = pValue; // Вставляю его в нужное место

  replaceP.replaceWith(input); // Место замены кнопки

  var replaceBtn = document.getElementById(e.target.id); // Создаю и настраиваю кнопку

  var inputSave = document.createElement('input');
  inputSave.className = 'comments__in-save btn';
  inputSave.type = 'submit';
  inputSave.innerHTML = 'Сохранить'; // Вставляю его в нужное место

  replaceBtn.replaceWith(inputSave);
  var replaceDiv = document.getElementById("div" + e.target.id);
